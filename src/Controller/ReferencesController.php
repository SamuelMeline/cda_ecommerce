...
class ReferencesController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(Reference::class, $reference);
    ...
    public function edit(Request $request, Reference $reference, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(Reference::class, $reference);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Reference $reference, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$reference->getId(), $request->getPayload()->get('_token'))) {
